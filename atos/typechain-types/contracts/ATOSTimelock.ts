...
export interface ATOSTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ATOSTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): ATOSTimelock;
  waitForDeployment(): Promise<this>;

  interface: ATOSTimelockInterface;
