...
export interface ATOSTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "setMetadataCID",
    values: [string]
  ): string;
  encodeFunctionData(
...
export namespace MetadataCIDUpdatedEvent {
...
export namespace TreasuryBurnEvent {
  ...
  export type OutputTuple = [burner: string, from: string, amount: bigint];
  export interface OutputObject {
    burner: string;
    from: string;
    amount: bigint;
...
export interface ATOSToken extends BaseContract {
  connect(runner?: ContractRunner | null): ATOSToken;
  waitForDeployment(): Promise<this>;

  interface: ATOSTokenInterface;
  ...
  setMetadataCID: TypedContractMethod<[newCID: string], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "setMetadataCID"
  ...
  >;
  getEvent(
    key: "MetadataCIDUpdated"
  ): TypedContractEvent<
    MetadataCIDUpdatedEvent.InputTuple,
    MetadataCIDUpdatedEvent.OutputTuple,
    MetadataCIDUpdatedEvent.OutputObject
  >;
  getEvent(
    key: "Paused"
  ): TypedContractEvent<
  ...
  getEvent(
    ...
    TreasuryBurnEvent.InputTuple,
    TreasuryBurnEvent.OutputTuple,
    TreasuryBurnEvent.OutputObject
  >;
  getEvent(
    key: "Unpaused"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "MetadataCIDUpdated(string,string)": TypedContractEvent<
      MetadataCIDUpdatedEvent.InputTuple,
      MetadataCIDUpdatedEvent.OutputTuple,
      MetadataCIDUpdatedEvent.OutputObject
    >;
    MetadataCIDUpdated: TypedContractEvent<
      MetadataCIDUpdatedEvent.InputTuple,
      MetadataCIDUpdatedEvent.OutputTuple,
      MetadataCIDUpdatedEvent.OutputObject
    >;
    ...
    "TreasuryBurn(address,address,uint256)": TypedContractEvent<
      TreasuryBurnEvent.InputTuple,
      TreasuryBurnEvent.OutputTuple,
      TreasuryBurnEvent.OutputObject
    >;
    TreasuryBurn: TypedContractEvent<
      TreasuryBurnEvent.InputTuple,
      TreasuryBurnEvent.OutputTuple,
      TreasuryBurnEvent.OutputObject
    >;
