...
import type { Await, Store, AbortOptions, AwaitGenerator } from 'interface-store';
...
export interface Datastore<HasOptionsExtension = {}, PutOptionsExtension = {}, PutManyOptionsExtension = {}, GetOptionsExtension = {}, GetManyOptionsExtension = {}, DeleteOptionsExtension = {}, DeleteManyOptionsExtension = {}, QueryOptionsExtension = {}, QueryKeysOptionsExtension = {}, BatchOptionsExtension = {}> extends Store<Key, Uint8Array, Await<Uint8Array>, Pair, Pair, HasOptionsExtension, PutOptionsExtension, PutManyOptionsExtension, GetOptionsExtension, GetManyOptionsExtension, DeleteOptionsExtension, DeleteManyOptionsExtension> {
    /**
...
export interface KeyQueryFilter {
    (item: Key): boolean;
}
export interface KeyQueryOrder {
    (a: Key, b: Key): -1 | 0 | 1;
}
