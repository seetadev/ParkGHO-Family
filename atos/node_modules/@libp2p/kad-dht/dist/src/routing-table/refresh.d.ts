...
export declare class RoutingTableRefresh {
     ...
     */
    refreshTable(force?: boolean, options?: AbortOptions): void;
    _refreshCommonPrefixLength(cpl: number, lastRefresh: Date, force: boolean, options?: AbortOptions): Promise<void>;
