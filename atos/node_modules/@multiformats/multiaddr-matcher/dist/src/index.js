...
const _HTTP = and(_IP_OR_DOMAIN, or(and(value(CODE_TCP, '80')), and(value(CODE_TCP), code(CODE_HTTP)), code(CODE_HTTP)), optional(value(CODE_HTTP_PATH)), optional(value(CODE_P2P)));
/**
...
const _HTTPS = and(_IP_OR_DOMAIN, or(and(value(CODE_TCP, '443')), and(value(CODE_TCP, '443'), code(CODE_HTTP)), and(value(CODE_TCP), code(CODE_HTTPS)), and(value(CODE_TCP), code(CODE_TLS), code(CODE_HTTP)), and(code(CODE_TLS), code(CODE_HTTP)), code(CODE_TLS), code(CODE_HTTPS)), optional(value(CODE_HTTP_PATH)), optional(value(CODE_P2P)));
/**
