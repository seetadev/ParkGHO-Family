...
const fork_recommendations_banner_1 = require("../internal/hardhat-network/provider/utils/fork-recommendations-banner");
...
(0, config_env_1.subtask)(task_names_1.TASK_TEST_RUN_SHOW_FORK_RECOMMENDATIONS).setAction(async (_, { config, network }) => {
    ...
    await (0, fork_recommendations_banner_1.showForkRecommendationsBannerIfNecessary)(network.config, forkCache);
});
