...
class CompilerDownloader {
    ...
    async getCompiler(version) {
        ...
        if (await fs_extra_1.default.pathExists(this._getCompilerDoesNotWorkFile(build))) {
            return undefined;
        }
        return {
            version,
    ...
    async _getCompilerBuild(version) {
        ...
        return list.builds.find((b) => b.version === version && b.prerelease === undefined);
    }
    ...
    _getCompilerDoesNotWorkFile(build) {
    ...
    async _postProcessCompilerDownload(build, downloadPath) {
        ...
        await fs_extra_1.default.createFile(this._getCompilerDoesNotWorkFile(build));
    }
