...
(0, config_1.subtask)(task_names_1.TASK_VERIFY_SOURCIFY_ATTEMPT_VERIFICATION)
    ...
    const { contractName, contractOutput, compilerInput } = contractInformation;
    const parsedMetadata = JSON.parse(contractOutput.metadata);
    const sourcesToContent = Object.fromEntries(Object.keys(parsedMetadata.sources).map((name) => [
        name,
