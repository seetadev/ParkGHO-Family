...
contract CrossSourceMinter {
    ...
    constructor(address destMinterAddress) {
        ...
        address routerAddressOptimism = 0x9C32fCB86BF0f4a1A8921a9Fe46de3198bb884B2;
    ...
    function mintOnSepolia(string memory uri, address _minter) external {
        // Mint from Fuji network = chain[1]
        Client.EVM2AnyMessage memory message = Client.EVM2AnyMessage({
            receiver: abi.encode(destinationMinter),
            data: abi.encodeWithSignature("mintFrom(address,string)", _minter, uri),
